...
<div class="container">
	<form class="body container" action="${contextPath}/admin/webtoonUpload" method="post" enctype="multipart/form-data">
		<div style="display: flex;">
			<div>
				<img id="webtoonImage" src="${contextPath }/resources/img/webtoon/default_image.png" width=100 height=100
					alt="선택된 이미지가 없습니다" />
			</div>
			<div>
